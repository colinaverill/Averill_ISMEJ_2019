...
fig_S5.path <- 'Figures/Fig_S5._covariate_correlations_LT.png'
fig_S6.path <- 'Figures/Fig_S6._covariate_correlations_JT.png'
fig_S7.path <- 'Figures/Fig_S7._LT_space_time_distances_vs_predictors.png'
fig_S8.path <- 'Figures/Fig_S8._JT_space_time_distances_vs_predictors.png'
fig_S9.path <- 'Figures/Fig_S9._Monte_Carlo_results.png'
