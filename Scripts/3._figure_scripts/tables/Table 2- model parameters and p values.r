...
tal <- readRDS('/fs/data3/caverill/Microbial_Space_Time_data/talbot_2014.data/figure_data/talbot_data_fitted_st.env.rds')
tal.st <- tal[[5]]
tal.env <- tal[[6]]
tal.st.env <- tal[[7]]

ted <- readRDS('/fs/data3/caverill/Microbial_Space_Time_data/tedersoo_2014.data/figure_data/tedersoo_data_fitted_st.env.rds')
ted.st <- ted[[5]]
ted.env <- ted[[6]]
ted.st.env <- ted[[7]]
